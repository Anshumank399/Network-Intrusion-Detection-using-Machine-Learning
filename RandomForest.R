...
data1 <- data[,c("SrvRerrorRate", "RerrorRate", "Flag",  "DstHostRerrorRate", "LoggedIn", "ProtocolType","Attack" )]
...
output.forest <- randomForest(Attack ~ SrvRerrorRate + RerrorRate +Flag+DstHostRerrorRate +LoggedIn+ProtocolType, data = training)
print(output.forest)
plot (output.forest)
